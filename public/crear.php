...
<body>
    <form class="max-w-sm mx-auto" action="crear.php" method="POST" enctype="multipart/form-data">
        <div class="mb-5">
            <label for="nombre" class="block mb-2 text-sm font-medium text-gray-900 :text-white">Nombre</label>
            <input type="text" id="nombre" name="nombre" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 :bg-gray-700 :border-gray-600 :placeholder-gray-400 :text-white :focus:ring-blue-500 :focus:border-blue-500" placeholder="name@flowbite.com" required>
        ...
        <div class="mb-5">
            ...
            <input type="text" id="precio" name="precio" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 :bg-gray-700 :border-gray-600 :placeholder-gray-400 :text-white :focus:ring-blue-500 :focus:border-blue-500" placeholder="name@flowbite.com" required>
        ...
        <div class="mb-4 flex justify-between gap-10">
            ...
            <div>
                <img src="./img/articulos/default.png" alt="default-book" width="150px" class="rounded" id="img">
            </div>
        </div>
        <?php Utils::mostrarErrores("img_error") ?>
        <div class="flex items-start my-5">
            <div class="flex items-center h-5">
                <input id="disponible" name="disponible" type="checkbox" value="" class="w-4 h-4 border border-gray-300 rounded bg-gray-50 focus:ring-3 focus:ring-blue-300 :bg-gray-700 :border-gray-600 :focus:ring-blue-600 :ring-offset-gray-800 :focus:ring-offset-gray-800">
            </div>
